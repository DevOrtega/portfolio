      ...
      <div class="order-2 lg:order-1 text-center lg:text-left space-y-8">
        ...
        <div class="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 pt-4">
          <a v-if="personalInfo.github_url" :href="personalInfo.github_url" target="_blank" 
             class="px-5 sm:px-8 py-2.5 sm:py-3 bg-gray-800 hover:bg-gray-700 text-white rounded-full transition-all duration-300 border border-gray-700 hover:border-indigo-500 flex items-center gap-2 group shadow-lg hover:shadow-indigo-500/20 text-sm sm:text-base">
            <span>GitHub</span>
            <svg class="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clip-rule="evenodd"></path></svg>
          </a>
          <a v-if="personalInfo.linkedin_url" :href="personalInfo.linkedin_url" target="_blank" 
             class="px-5 sm:px-8 py-2.5 sm:py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-full transition-all duration-300 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 flex items-center gap-2 hover:-translate-y-0.5 text-sm sm:text-base">
            <span>LinkedIn</span>
          ...
          <router-link to="/projects" class="px-5 sm:px-8 py-2.5 sm:py-3 bg-transparent hover:bg-white/5 text-white rounded-full transition-all duration-300 border border-white/20 hover:border-white/50 flex items-center gap-2 text-sm sm:text-base">

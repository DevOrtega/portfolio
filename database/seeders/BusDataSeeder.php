    ...
    private function getRoutesData(): array
    {
        return [
            ...
            [
                ...
                'company' => 'municipales',
                'origin' => 'Teatro',
                'destination' => 'Campus ULPGC',
                'color' => '#FDB913',
                'stopsOutbound' => ['teatro', 'sanTelmo', 'triana', 'sanJose', 'tafiraBaja', 'campusULPGC'],
                'stopsInbound' => ['campusULPGC', 'tafiraBaja', 'sanJose', 'triana', 'sanTelmo', 'teatro'],
            ],
            [
                'line' => '25',
                'type' => 'urban',
                ...
                'color' => '#FDB913',
                'stopsOutbound' => ['teatro', 'sanTelmo', 'triana', 'laPaterna', 'sanLorenzo', 'tamaraceite'],
                'stopsInbound' => ['tamaraceite', 'sanLorenzo', 'laPaterna', 'triana', 'sanTelmo', 'teatro'],
            ],
            [
                'line' => '26',
                'type' => 'urban',
                'company' => 'municipales',
                'origin' => 'Puerto',
                'destination' => 'Guanarteme',
                'color' => '#FDB913',
                'stopsOutbound' => ['puerto', 'santaCatalina', 'canteras', 'guanarteme', 'auditorio'],
                'stopsInbound' => ['auditorio', 'guanarteme', 'canteras', 'santaCatalina', 'puerto'],
            ],
            ...
            [
                ...
                'color' => '#0066CC',
                'stopsOutbound' => ['estacionSanTelmo', 'telde', 'aeropuerto', 'vecindario', 'sanAgustin', 'playaIngles', 'maspalomas'],
                'stopsInbound' => ['maspalomas', 'playaIngles', 'sanAgustin', 'vecindario', 'aeropuerto', 'telde', 'estacionSanTelmo'],
            ],
            [
                'line' => '5',
                'type' => 'interurban',
                ...
                'color' => '#0066CC',
                'stopsOutbound' => ['estacionSanTelmo', 'telde', 'aeropuerto'],
                'stopsInbound' => ['aeropuerto', 'telde', 'estacionSanTelmo'],
            ],
            [
                'line' => '30',
                'type' => 'interurban',
                'company' => 'global',
                'origin' => 'Las Palmas',
                'destination' => 'Puerto Mogán',
                'color' => '#0066CC',
                'stopsOutbound' => ['estacionSanTelmo', 'maspalomas', 'arguineguin', 'puertoRico', 'taurito', 'puertoMogan'],
                'stopsInbound' => ['puertoMogan', 'taurito', 'puertoRico', 'arguineguin', 'maspalomas', 'estacionSanTelmo'],
            ],
            [
                'line' => '60',
                'type' => 'interurban',
                ...
                'destination' => 'Gáldar',
                'color' => '#0066CC',
                'stopsOutbound' => ['estacionSanTelmo', 'arucas', 'guia', 'galdar'],
                'stopsInbound' => ['galdar', 'guia', 'arucas', 'estacionSanTelmo'],
            ],
            [
                'line' => '91',
                'type' => 'interurban',
                ...
                'destination' => 'Agaete',
                'color' => '#0066CC',
                'stopsOutbound' => ['estacionSanTelmo', 'arucas', 'galdar', 'agaete', 'puertoNieves'],
                'stopsInbound' => ['puertoNieves', 'agaete', 'galdar', 'arucas', 'estacionSanTelmo'],
            ],
            [
                'line' => '105',
                'type' => 'interurban',
                'company' => 'global',
                'origin' => 'Las Palmas',
                'destination' => 'Santa Brígida',
                'color' => '#0066CC',
                'stopsOutbound' => ['estacionSanTelmo', 'tafiraBaja', 'santaBrigida'],
                'stopsInbound' => ['santaBrigida', 'tafiraBaja', 'estacionSanTelmo'],
            ],
            ...
            [
                ...
                'destination' => 'Puerto',
                'color' => '#9933FF',
                'stopsOutbound' => ['teatro', 'sanTelmo', 'triana', 'mesaYLopez', 'santaCatalina', 'puerto'],
                'stopsInbound' => ['puerto', 'santaCatalina', 'mesaYLopez', 'triana', 'sanTelmo', 'teatro'],
            ],
            [
                'line' => 'L2',
                'type' => 'night',
                ...
                'destination' => 'Tamaraceite',
                'color' => '#9933FF',
                'stopsOutbound' => ['teatro', 'sanTelmo', 'schamann', 'escaleritas', 'sietePalmas', 'tamaraceite'],
                'stopsInbound' => ['tamaraceite', 'sietePalmas', 'escaleritas', 'schamann', 'sanTelmo', 'teatro'],
            ],
            [
                'line' => 'L3',
                'type' => 'night',
                ...
                'destination' => 'Hoya de La Plata',
                'color' => '#9933FF',
                'stopsOutbound' => ['teatro', 'sanTelmo', 'sanJose', 'ciudadJusticia', 'hoyaDeLaPlata'],
                'stopsInbound' => ['hoyaDeLaPlata', 'ciudadJusticia', 'sanJose', 'sanTelmo', 'teatro'],
            ],
        ];
    }
}
